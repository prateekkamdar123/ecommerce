                ...
                <div class="row gap-20 masonry pos-r">
                    ...
                    <div class="masonry-item col-md-6">
                        <div class="bgc-white p-20 bd"><h6 class="c-grey-900">Basic Form</h6>
                            <div class="mT-30">
                                <s:form action="/uploadtimetable" method="post" modelAttribute="faculty" enctype="multipart/form-data">
                                    <s:hidden path="id" />
                                    <div class="form-group"><label for="exampleInputEmail1">Upload Time Table</label><input
                                            type="file" class="form-control" id="exampleInputEmail1" name="file"
                                            aria-describedby="emailHelp" placeholder="Upload Time Table..">
