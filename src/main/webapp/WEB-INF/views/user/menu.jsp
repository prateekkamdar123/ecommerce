...
<ul class="sidebar-menu scrollable pos-r">
    ...
    <li class="nav-item"><a class="sidebar-link" href="/updateprofile"><span class="icon-holder"><i
            class="c-brown-500 ti-email"></i> </span><span class="title">Update Profile</span></a></li>
    <li class="nav-item"><a class="sidebar-link" href="/showtt"><span class="icon-holder"><i
            class="c-blue-500 ti-share"></i> </span><span class="title">Time Table</span></a></li>
